...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Annotation.created_date'
        db.add_column('photos_annotation', 'created_date', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2011, 8, 25, 21, 35, 46, 390230), blank=True), keep_default=False)

        # Adding field 'Annotation.published_date'
        db.add_column('photos_annotation', 'published_date', self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Annotation.created_date'
        db.delete_column('photos_annotation', 'created_date')

        # Deleting field 'Annotation.published_date'
        db.delete_column('photos_annotation', 'published_date')
