...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('auth_userprofile', 'is_active')


    def backwards(self, orm):
        
        # Adding field 'UserProfile.is_active'
        db.add_column('auth_userprofile', 'is_active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
