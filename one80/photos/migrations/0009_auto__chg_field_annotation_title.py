...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.title'
        db.alter_column('photos_annotation', 'title', self.gf('django.db.models.fields.CharField')(max_length=255))


    def backwards(self, orm):
        
        # Changing field 'Annotation.title'
        db.alter_column('photos_annotation', 'title', self.gf('django.db.models.fields.CharField')(max_length=128))
