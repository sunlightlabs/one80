...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Annotation.thumbnail'
        db.alter_column('photos_annotation', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=255, null=True))


    def backwards(self, orm):
        
        # Changing field 'Annotation.thumbnail'
        db.alter_column('photos_annotation', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True))
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 30, 13, 14, 53, 294842)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 7, 30, 13, 14, 53, 294680)'}),
