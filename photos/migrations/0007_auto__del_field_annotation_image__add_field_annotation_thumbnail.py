...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Annotation.image'
        db.delete_column('photos_annotation', 'image')

        # Adding field 'Annotation.thumbnail'
        db.add_column('photos_annotation', 'thumbnail', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'Annotation.image'
        db.add_column('photos_annotation', 'image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, blank=True), keep_default=False)

        # Deleting field 'Annotation.thumbnail'
        db.delete_column('photos_annotation', 'thumbnail')
