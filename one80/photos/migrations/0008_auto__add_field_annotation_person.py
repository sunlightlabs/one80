...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Annotation.person'
        db.add_column('photos_annotation', 'person', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='annotations', null=True, to=orm['people.Person']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Annotation.person'
        db.delete_column('photos_annotation', 'person_id')
